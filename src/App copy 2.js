...
function App() {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      {/* Agent switcher — runs PRD and UAT agents in parallel (switch without losing state) */}
      <div
        style={{
          display: "flex",
          alignItems: "center",
      ...
      <div style={{ flex: 1, minHeight: "calc(100vh - 40px)", display: activeTab === TAB_BRD ? "block" : "none" }}>
        <iframe
          src="/brdforge.html"
          title="BRD Agent"
